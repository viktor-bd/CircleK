...
public class ProductView extends JFrame {
	...
	public ProductView() {
		...
		JButton btnNewButton_1 = new JButton("Tilføj kunde");
		btnNewButton_1.setBounds(335, 28, 89, 23);
		panel.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Godkend ");
		btnNewButton_2.setBounds(335, 220, 89, 30);
		panel.add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("Tilbage");
		btnNewButton_3.setBounds(335, 51, 89, 23);
		panel.add(btnNewButton_3);
		
		JLabel lblNewLabel_1 = new JLabel("Ordrelinjer");
		lblNewLabel_1.setBounds(213, 11, 118, 14);
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Pris:");
		lblNewLabel_2.setBounds(213, 236, 46, 14);
